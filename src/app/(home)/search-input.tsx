  ...
  <div className='flex-1 flex items-center justify-center'>
   <form onSubmit={handleSubmit} className='relative max-w-[720px] w-full'>
    ...
    <Button
     ...
     variant='ghost'
     size='icon'
     className='absolute left-3 top-1/2 -translate-y-1/25 [&_svg]:size-5 rounded-full'
    >
     <SearchIcon />
    </Button>
    {value && (
     <Button
      ...
      variant='ghost'
      size='icon'
      className='absolute right-3 top-1/2 -translate-y-1/25 [&_svg]:size-5 rounded-full'
     >
      <XIcon />
     </Button>
    )}
